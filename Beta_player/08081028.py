...
class MainWindow(QWidget):
    ...
    def init_ui(self):
        ...
        pushB_Stop_All.setIcon(self.style().standardIcon(QStyle.SP_MediaStop))
        pushB_Stop_All.clicked.connect(self.stop_all)
        pushB_reset_toa = QPushButton()
        pushB_reset_toa.setIcon(self.style().standardIcon(QStyle.SP_MediaVolumeMuted))
        pushB_reset_toa.clicked.connect(self.reset_to_a)
        hbox_PB = QHBoxLayout()
    ...
    def play_all(self):
        print("play all")
        if (self.window1.mediaPlayer.state() == QMediaPlayer.PlayingState) or (
                self.window2.mediaPlayer.state() == QMediaPlayer.PlayingState):
    ...
    def reset_to_a(self):
        ...
        self.window2.mediaPlayer.setPosition(self.window1.slider.value())
        self.window2.mediaPlayer.setPosition(self.window1.slider.value())
